// Reserve Bank of New Zealand exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/rbnz';
...
/** Latest rate for one pair, e.g. getRate('NZD', 'USD', { apiKey }). */
